...
export default function FetchPokemon() {
  ...
  console.log(loading);
	...
	for (let i = 1; i <= Math.ceil((pokemonData?.results.length || 0) / postsPerPage); i++) {
  ...
  return (
    ...
    <div>
      {pokemonData ? (
		...
		<PokemonList posts={pokemonData.results} loading={loading} currentPage={currentPage} postsPerPage={postsPerPage} />
